...
const ProductCard = ({avatar}:ProductCardProps) => {
  ...
  return (
    <div className='space-y-[1px] text-sm w-96'>
        ...
        <p className=' text-base font-semibold'>Avatar name &quot;Avatown&quot; -nice original avatar of Avatown</p>
        ...
        <div >
          ...
          <UploadIcon onMouseOver={()=>setShowLink(true)} onMouseLeave={()=>setShowLink(true)}  className=' cursor-pointer' />
        </div>
        </div>
    </div>
  )
