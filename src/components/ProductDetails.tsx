  ...
  return (
    <div className=" w-full  flex flex-row ">
      <div className="flex flex-col ">
        <div className="flex w-[1200px] h-[600px] relative top-32 left-6 bg-white rounded-xl overflow-hidden shadow-2xl">
          ...
          <div className=" w-[1600px] space-y-4 py-6 px-12">
            ...
            <div className="flex flex-row justify-between pt-12">
              <button
                className=" bg-blue-900 text-white px-6 py-2 rounded-full hover:bg-white
             hover:text-blue-900 hover:border hover:border-blue-900"
              >
                Buy Now
              </button>
              <button
                className=" bg-purple-600 text-white px-6 py-2 rounded-full hover:bg-white
